...
import (
	...
	"github.com/dseapy/grafana-numaflow-datasource/pkg/plugin"
...
func main() {
	...
	if err := datasource.Manage("grafana-numaflow-datasource", plugin.NewDatasource, datasource.ManageOpts{}); err != nil {
